...
class UtauElementBuilder (
    val blockName: String="#INSERT",
    attrMap:Map[String, String]=Map.empty[String,String]) {

  def this(attrMap:Map[String, String]) = this("#INSERT", attrMap)
  def this(e:UtauElement)= this(e.blockName,  Map.empty ++ e.attrMap)
  /**
